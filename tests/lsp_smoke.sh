...
msg_hover='{"jsonrpc":"2.0","id":2,"method":"textDocument/hover","params":{"textDocument":{"uri":"file:///test.lumi"},"position":{"line":4,"character":10}}}'
msg_completion='{"jsonrpc":"2.0","id":3,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///test.lumi"},"position":{"line":4,"character":10}}}'
...
grep -Fq '"severity":2' "$tmpdir/out.txt"
grep -Fq "unused local binding 'unused'" "$tmpdir/out.txt"
